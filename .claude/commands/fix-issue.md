...
!`gh issue view $ARGUMENTS --repo hrds100/bookingsite`

## Issue Comments

!`gh issue view $ARGUMENTS --repo hrds100/bookingsite --comments`
...
5. **Report** - use the DONE format from docs/AGENT_INSTRUCTIONS.md
...
- Do NOT remove mock data fallbacks unless wiring real data
