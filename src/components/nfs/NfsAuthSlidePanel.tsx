...
const SLIDES = [
  {
    ...
    stats: [
      ...
      { number: '4,200+', label: 'Happy guests' },
    ],
  },
  {
    image: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=1200&fit=crop',
    headline: 'List your property. Reach more guests.',
    body: 'Operators manage properties, reservations, and payouts — all in one platform.',
    type: 'bullets' as const,
    bullets: [
      'Instant booking management dashboard',
...
export function NfsAuthSlidePanel() {
  ...
  return (
    <div data-feature="NFSTAY__AUTH_PANEL" className="relative w-1/2 h-full overflow-hidden rounded-3xl hidden lg:flex flex-shrink-0">
      {/* Slides */}
      {SLIDES.map((slide, i) => (
        <div
          key={i}
