...
export function NfsMainFooter() {
  ...
  const socialLinks = isWhiteLabel && operator
    ? [
        operator.social_instagram && { label: "Instagram", url: operator.social_instagram, icon: <Instagram className="w-5 h-5" /> },
        operator.social_facebook  && { label: "Facebook",  url: operator.social_facebook,  icon: <Facebook  className="w-5 h-5" /> },
        operator.social_twitter   && { label: "Twitter",   url: operator.social_twitter,   icon: <Twitter   className="w-5 h-5" /> },
          ...
          <div data-feature="NFSTAY__FOOTER_ABOUT" className="col-span-2 sm:col-span-1">
            ...
            {!isWhiteLabel && (
              <div data-feature="NFSTAY__FOOTER_SOCIAL" className="flex gap-2 mt-1">
                {[
                  { label: "Instagram", href: "https://instagram.com/nfstay",          icon: <Instagram className="w-5 h-5" /> },
                  { label: "Facebook",  href: "https://facebook.com/nfstay",            icon: <Facebook  className="w-5 h-5" /> },
                  { label: "Twitter",   href: "https://x.com/nfstay",                   icon: <Twitter   className="w-5 h-5" /> },
                  { label: "LinkedIn",  href: "https://linkedin.com/company/nfstay",    icon: <Linkedin  className="w-5 h-5" /> },
                ].map((s) => (
                  <a
                    key={s.label}
                    href={s.href}
